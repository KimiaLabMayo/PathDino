...
def pathdino(patch_size=16, **kwargs):
    model = VisionTransformer(img_size=[512], patch_size=patch_size, embed_dim=384, depth=5, num_heads=6, mlp_ratio=4, qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    return model
